...
face_detection_model = 'yolo' # "yolo" ili "faceBoxes"
...
rppg_dir = f"{root_dir}/{face_detection_model}/{segment_id}/{framerate_id}/rppg" # gdje ce se kreirati rppg folderi
    ...
    for person in havent_done:
        ...
        for task in [1,2,3]:
            ...
            for segment in range(number_of_segments):
                ...
                frame_num = 0 # koliko frejmova je procitano -> uvijek 6325
                ...
                while True:
                    ...
                    # memorija se oslobadja - smanji opterecenje RAM-a??
                    ...
                    for contents, frame_num in batch_of_frames_bytes:
                        ...
                        if isinstance(predicted_array, tuple):
                            ...
                            face_not_found_image.save(face_not_found_image_path)
                            continue
                        ...
                        # # 3 linije koda za cuvanje izlaza iz skin_segment funkcije, samo za prezentaciju kako izgleda slika na izlazu
